	...
	<div class="hnav clearfix">
		<div class="row-fluid">
			<ul class="hnav-main text-center unstyled pull-left" style="width:55%;">
				<li class="hnav-parent {if $do == 'profile'}active{/if}"><a href="./?do=profile">当前公众号</a></li>
				<li class="hnav-parent {if $do == 'global'}active{/if}"><a href="./?do=global">全局设置</a></li>
				...
				{if IMS_FAMILY == 'v' || $_W['isfounder']}<li class="hnav-parent"><a href="http://bbs.we7.cc/" target="_blank">微擎论坛</a></li>{/if}
			...
			<tr>
				<td valign="top" height="100%" class="content-left" style="overflow:hidden;">
					<div class="sidebar-nav" style="">
						{loop $mset $g}
						{if $g['menus']}
						<span class="snav-big"><i class="icon-folder-open"></i> {$g['title']}</span>
						{loop $g['menus'] $menu}
